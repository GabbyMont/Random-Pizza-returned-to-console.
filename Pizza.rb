def crust
	crust = ["flatbread","thin","deep dish","Focaccia"].sample
end
...
def veggies
	veggies = ["bell peppers","jalapeno","onion","spinach"].sample
end
...
def extra
	extra = ["cheese","plantains", "bell peppers","sausage"].sample
end
...
puts "We have wings in sizes of: #{wings}, #{wings}, and #{wings}."
puts "We have flavors of wings in: #{flavors_of_wings}, #{flavors_of_wings}, #{flavors_of_wings}, #{flavors_of_wings}, #{flavors_of_wings}, #{flavors_of_wings}, and #{flavors_of_wings}."
puts "We also have a selection of drinks: #{drink_choice}, #{drink_choice}, #{drink_choice}"
puts "We have these select salad types: #{salad_type}, #{salad_type}, #{salad_type}, #{salad_type}, #{salad_type}, #{salad_type}"
puts "We also have #{pasta_type}, #{pasta_type}, and #{pasta_type} pasta."
